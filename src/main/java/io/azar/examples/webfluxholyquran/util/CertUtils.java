...
public class CertUtils {
	 ...
	 * <b>Steps:</b>
	 * <ol>
	 * <li><b>Initialize Truststore:</b> Create a new instance of KeyStore using the
	 * PKCS12 type.</li>
	 * <li><b>Load Truststore:</b> Load the truststore with a default keystore password
	 * (null values).</li>
	 * <li><b>Read PEM Certificates:</b> Use a PEMParser to parse the concatenated PEM
	 * certificates.</li>
	 * <li><b>Process PEM Objects:</b> Iterate through the PEM objects read by the parser.
	 * <ul>
	 * <li>a. If the PEM object is an X509CertificateHolder, convert it to an
	 * X509Certificate.</li>
	 ...
	 * @throws Exception If there is an issue during the truststore creation or
	 ...
	 * <b>Steps:</b>
	 * <ol>
	 * <li><b>Initialize Certificates List:</b> Create an empty list to store X.509
	 * certificates.</li>
	 * <li><b>Read PEM Certificates:</b> Use a PEMParser to parse the concatenated PEM
	 * certificates.</li>
	 * <li><b>Process PEM Objects:</b> Iterate through the PEM objects read by the parser.
	 ...
	 * @throws Exception If there is an issue during the certificate loading or
	 * conversion.
	 */
